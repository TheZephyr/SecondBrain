    ...
    <template v-if="type === 'date'">
      <div class="space-y-3">
        <div>
          ...
          <Select :modelValue="dateFormat" @update:modelValue="value => updateDateFormat(value)"
    ...
    <template v-if="type !== 'boolean'">
      <div>
        ...
        <template v-if="type === 'text' || type === 'longtext' || type === 'url'">
          <InputText :modelValue="stringDefault" @update:modelValue="value => updateDefaultValue(value)"
            class="w-full" />
        </template>
        <template v-else-if="type === 'number'">
          <InputNumber :modelValue="numberDefault" @update:modelValue="value => updateDefaultValue(value)"
            inputClass="w-full" class="w-full" />
        </template>
        <template v-else-if="type === 'date'">
          <div class="space-y-2">
            <Select :modelValue="dateDefaultMode" @update:modelValue="value => updateDateDefaultMode(value)"
        ...
        <template v-else-if="type === 'select'">
          <Select :modelValue="selectDefault" @update:modelValue="value => updateDefaultValue(value)"
            :options="selectDefaultOptions" optionLabel="label" optionValue="value" class="w-full" />
        </template>
        <template v-else-if="type === 'multiselect'">
          <MultiSelect :modelValue="multiselectDefault" @update:modelValue="value => updateDefaultValue(value)"
            :options="choices" display="chip" class="w-full" />
        </template>
      ...
      <div>
        ...
        <div class="grid grid-cols-2 gap-2 sm:grid-cols-4">
          <button v-for="icon in booleanIcons" :key="icon" type="button"
            ...
            :class="booleanIcon === icon ? 'bg-[var(--bg-hover)]' : ''" @click="updateBooleanIcon(icon)">
