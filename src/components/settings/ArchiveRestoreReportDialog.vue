  ...
  >
    <div v-if="report" class="space-y-4">
      ...
      <div class="rounded-lg border border-[var(--border-color)] bg-[var(--bg-primary)] p-4">
        ...
        <div class="mt-3 space-y-2" v-if="report.droppedViewReferences.length > 0">
          <div
      ...
      <div class="grid gap-3 md:grid-cols-2">
        <div class="rounded-lg border border-[var(--border-color)] bg-[var(--bg-primary)] p-4">
          ...
          <div class="mt-3 space-y-2" v-if="report.skippedEntities.length > 0">
            <div
        ...
        <div class="rounded-lg border border-[var(--border-color)] bg-[var(--bg-primary)] p-4">
          ...
          <div class="mt-3 space-y-2" v-if="report.statMismatches.length > 0">
            <div
