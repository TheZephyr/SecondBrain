  ...
  >
    ...
    >
      <div class="divide-y divide-[var(--border-color)]/70">
        ...
        >
          <component :is="viewType.icon" class="size-4 text-[var(--accent-primary)]" />
          <span class="flex-1 text-left">{{ viewType.label }}</span>
          <Plus class="size-4 text-[var(--accent-primary)] opacity-70 transition-opacity group-hover:opacity-100" />
        </button>
      </div>
    </div>
  </Transition>
